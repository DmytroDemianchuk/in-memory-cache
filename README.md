# example
Не розумію чому не працює, підкажіть будь ласка як потрібно було зробити правельно. Я не знаю який я маю написать под під вказаний модуль, тому взяв який рандомний з ютубу.
